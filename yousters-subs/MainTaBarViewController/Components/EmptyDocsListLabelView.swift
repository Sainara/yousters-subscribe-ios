...
class EmptyDocsListLabelView: YoustersComponentView {
    
    var text:String = "Вы пока ничего не добавили, чтобы это исправить нажмите на \"+\" вверху экрана"

    init(opacity:Float = 1.0, text:String? = nil) {
